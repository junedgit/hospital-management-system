  ...
  createRoutesFromElements(
    <Route>
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route
          element={
            <ProtectedRoute requiredRoles={["reception", "clinicAdmin"]} />
          }
        >
        ...
        <Route
          element={<ProtectedRoute requiredRoles={["doctor", "clinicAdmin"]} />}
        >
        ...
        <Route
          element={<ProtectedRoute requiredRoles={["nurse", "clinicAdmin"]} />}
        >
          ...
          <Route
            path="admission-note-patient"
            element={<AdmissionNotePatient />}
          />
        </Route>

        {/* Lab routes - require 'lab' role */}
        <Route
          element={<ProtectedRoute requiredRoles={["lab", "clinicAdmin"]} />}
        >
          <Route
            path="test-parameters-master"
            element={<TestParameterMaster />}
          />
